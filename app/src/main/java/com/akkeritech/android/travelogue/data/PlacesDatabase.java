...
public final class PlacesDatabase {
    public static final String AUTHORITY = "com.akkeritech.android.travelogue.data.provider";
    ...
    public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.akkeritech.android.travelogue.data.provider.table";

    public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.akkeritech.android.travelogue.data.provider.table_item";
